package dev.anhndt.lab1.helper;
...
public class ListMapper<T, E> {
     ...
     * @param destinationType This is the type of class that it will convert to.
     ...
     */
    public List<E> mapList(List<T> list, Class<E> destinationType) {
        return list.stream()
