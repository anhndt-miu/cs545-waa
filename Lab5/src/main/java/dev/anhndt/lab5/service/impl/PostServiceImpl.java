...
import dev.anhndt.lab5.utils.ListMapper;
import dev.anhndt.lab5.repository.CommentRepository;
import dev.anhndt.lab5.repository.PostRepository;
...
public class PostServiceImpl implements PostService {
    ...
    public void createPost(PostDto post) {
        var postX = postRepository.save(modelMapper.map(post, Post.class));
//        var currentUser = jwtUtil.getUserDetailsFromToken();
    }
